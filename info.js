...
async function drawPage1(ctx) {
  ...
  const lines = [
    "Nickname: Christus", "Age: 16+", "DOB: 5 novembre 2008",
  ...
  ctx.shadowBlur = 25;
  ctx.fillText("🟣 To see Christus Bot's system info,", W / 2, H - 55);
...
async function drawPage2(ctx, uptimeMs, ping, users, threads) {
  ...
  ctx.shadowBlur = 18;
  ctx.fillText("Christus Bot", W / 2, 270);
